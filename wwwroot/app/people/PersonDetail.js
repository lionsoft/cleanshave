System.register(['angular2/core', 'angular2/common', 'angular2/router', './people.service'], function(exports_1) {
    ...
    var core_1, common_1, router_1, people_service_1;
    var PersonDetail;
    return {
        setters:[
            function (core_1_1) {
            ...
            PersonDetail = (function () {
                function PersonDetail(_peopleService, _routeParams, _router) {
                    ...
                    _peopleService.getPerson(id)
                        .subscribe(function (res) { return _this.person = res.json(); });
                }
